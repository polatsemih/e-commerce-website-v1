    ...
    function AdminCommentApprove()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($checked_inputs['error_message'])) {
                ...
                if ($result_check_csrf_token == true) {
                    parent::GetModel('CommentModel');
                    $result_comment_approve = $this->CommentModel->UpdateComment(array(
                        'is_comment_approved' => $is_comment_approved,
                        'id' => $checked_inputs['comment_id']
                    ));
    ...
    function AdminCommentReplyApprove()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($checked_inputs['error_message'])) {
                ...
                if ($result_check_csrf_token == true) {
                    parent::GetModel('CommentModel');
                    $result_comment_reply_approve = $this->CommentModel->UpdateCommentReply(array(
                        'is_comment_reply_approved' => $is_comment_reply_approved,
                        'id' => $checked_inputs['comment_reply_id']
                    ));
