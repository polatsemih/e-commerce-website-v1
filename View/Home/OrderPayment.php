    ...
    <main>
        <section class="order-complete-section container">
            ...
            <div class="order-complete-container">
                <?php if (!empty($web_data['order_result_title'])) : ?>
                    <span class="title-2"><?php echo $web_data['order_result_title']; ?></span>
                <?php endif; ?>
                <?php if (!empty($web_data['order_result_message'])) : ?>
                    <span class="text"><?php echo $web_data['order_result_message']; ?></span>
                <?php endif; ?>
