            ...
            <div class="row">
                ...
                <div class="agreements-container">
                    <?php if ($web_data['agreement_type'] == URL_AGREEMENT_TERMS) : ?>
                        ...
                        <p class="title-sub">1. Taraflar</p>
                        <p class="text">a) <?php echo DOMAIN; ?> internet sitesi, alt internet siteleri ve tüm sayfaları (bundan böyle "Platform" olarak anılacaktır) faaliyetlerini yürüten <?php echo COMPONY_FULL_NAME; ?> (bundan böyle "<?php echo BRAND; ?>" olarak anılacaktır.)</p>
                        <p class="text">b) Platform’a üye olan internet kullanıcısı bundan böyle "Üye" olarak anılacaktır.</p>

                        <p class="title-sub">2. Sözleşmenin Konusu</p>
                        <p class="text">İşbu Sözleşme’nin konusu, <?php echo BRAND; ?>'in sahip olduğu Platform’dan üyenin faydalanma şartlarının belirlenmesidir.</p>

                        <p class="title-sub">3. Hak ve Yükümlülükler</p>
                        <p class="text">3.1 Platform’a üye olunurken üyelik sayfasında belirtilen bilgilerin doğru ve eksiksiz şekilde girilmesi ve Üyelik Sözleşmesi’nin onaylanması gerekmektedir. Üye verdiği kişisel ve diğer sair bilgilerin kanunlar önünde doğru olduğunu, <?php echo BRAND; ?>'in bu bilgilerin gerçeğe aykırılığı nedeniyle uğrayacağı tüm zararları aynen ve derhal tazmin edeceğini beyan ve taahhüt eder.</p>
                        <p class="text">3.2. Üye, Platform’a üye olurken belirlediği şifreyi başka kişi ya da kuruluşlara veremez, üyenin söz konusu şifreyi kullanma hakkı bizzat kendisine aittir. Üye’nin Platform’a kayıt olurken kullandığı e posta adresinin ve belirlediği şifrenin güvenliği ve gizliliği tamamen Üye’nin sorumluluğundadır. Üye, kendisine ait e-posta ve şifre ile gerçekleştirilen işlemlerin kendisi tarafından gerçekleştirilmiş olduğunu, bu sebeple doğabilecek tüm sorumluluk ile üçüncü kişiler veya yetkili merciler tarafından <?php echo BRAND; ?>'e karşı ileri sürülebilecek tüm iddia ve taleplere karşı münhasıran sorumlu olduğunu ve <?php echo BRAND; ?>'in uğrayacağı her türlü zarar ve ziyanı karşılayacağını kabul, beyan ve taahhüt eder.</p>
                        <p class="text">3.3 Üye Platform’u kullanırken yasal mevzuat hükümlerine riayet etmeyi ve bunları ihlal etmemeyi kabul ve taahhüt eder. Aksi takdirde, doğacak tüm hukuki ve cezai yükümlülükler tamamen ve münhasıran üyeye ait olacaktır.</p>
                        <p class="text">3.4 Üye, Platform’u hiçbir şekilde kamu düzenini bozucu, genel ahlaka aykırı, başkalarını rahatsız ve taciz edici şekilde, yasalara aykırı bir amaç için, başkalarının fikri ve telif haklarına tecavüz edecek şekilde kullanamaz. Ayrıca, üye başkalarının hizmetleri kullanmasını önleyici veya zorlaştırıcı faaliyet (spam, virus, truva atı, vb.) ve işlemlerde bulunamaz. Platform'un bütününü veya herhangi bir bölümünü bozma, değiştirme, tersine mühendislik yapma amacıyla kullanamaz. Platform'a, Platform'un veri tabanına ve Platform üzerinde yer alan herhangi bir içeriğe zarar verici bir teknoloji kullanamaz veya virüs yayamaz. Platform'u herhangi yasadışı veya hileli amaçla kullanamaz.</p>
                        <p class="text">3.5 Platform’da üyeler tarafından beyan edilen, yazılan, kullanılan fikir,düşünce ve yorumlar, tamamen üyelerin kendi kişisel görüşleridir ve <?php echo BRAND; ?>'in bu fikir, düşünce ve yorumlarla ilgili herhangi bir sorumluluğu bulunmamaktadır <?php echo BRAND; ?>'e yöneltilebilecek herhangi bir talepte <?php echo BRAND; ?> ilgili talebi fikir, düşünce ve yorum sahibine iletecek olup tüm zarar ve ziyanını fikir, düşünce ve yorum sahibine rücu etme hakkı saklı olacaktır.</p>
                        <p class="text">3.6 İşbu üyelik sözleşmesi içerisinde sayılan maddelerden bir ya da birkaçını ihlal eden üye işbu ihlal nedeniyle cezai ve hukuki olarak şahsen sorumlu olup, <?php echo BRAND; ?>'i bu ihlallerin hukuki ve cezai sonuçlarından ari tutacaktır. Ayrıca; işbu ihlal nedeniyle, olayın hukuk alanına intikal ettirilmesi halinde, <?php echo BRAND; ?>'in üyeye karşı üyelik sözleşmesine uyulmamasından dolayı tazminat talebinde bulunma hakkı saklıdır.</p>
                        <p class="text">3.7. <?php echo BRAND; ?>'in her zaman tek taraflı olarak gerektiğinde üyenin üyeliğine son verme hakkı saklıdır. Üye, <?php echo BRAND; ?>'in bu hakkını kullanması halinde herhangi bir itirazda bulunmayacağını peşinen kabul eder.</p>
                        <p class="text">3.8. <?php echo BRAND; ?> markası ve logosu, Platform’un yazılım ve tasarımı ve bunlara ilişkin olarak <?php echo BRAND; ?> tarafından oluşturulan her türlü marka, tasarım, logo, slogan ve benzeri tüm içerik <?php echo BRAND; ?> mülkiyetindedir. Bunlara ilişkin sınai mülkiyet hakkı ve/veya diğer fikri mülkiyet hakları ilgili kanunlarca korunmakta olup, bunlar üye tarafından izinsiz kullanılamaz, iktisap edilemez ve değiştirilemez. Üye’nin <?php echo BRAND; ?>'in veya Platform’da satış yapanlar da dahil olmak üzere üçüncü kişilerin fikri mülkiyet haklarını ihlal etmesi halinde <?php echo BRAND; ?>'in söz konusu ihlalden kaynaklanan her türlü zararını tazmin ve sair talep hakkı saklıdır.</p>
                        <p class="text">3.9. Üye, <?php echo BRAND; ?> tarafından Platform’un iyileştirilmesi, geliştirilmesine yönelik olarak ve/veya yasal mevzuat çerçevesinde siteye erişmek için kullanılan İnternet servis sağlayıcısının adı ve Internet Protokol (IP) adresi, Siteye erişilen tarih ve saat, sitede bulunulan sırada erişilen sayfalar ve siteye doğrudan bağlanılmasını sağlayan Web sitesinin Internet adresi gibi birtakım bilgilerin toplanabileceğini kabul ve beyan eder.</p>
                        <p class="text">3.10. <?php echo BRAND; ?>, Platform’un virus ve benzeri amaçlı yazılımlardan arındırılmış olması için mevcut imkanlar dahilinde tedbir alınmıştır. Bunun yanında nihai güvenliğin sağlanması için kullanıcının, kendi virus koruma sistemini tedarik etmesi ve gerekli korunmayı sağlaması gerekmektedir. Bu bağlamda üye Platform’a girmesiyle, kendi yazılım ve işletim sistemlerinde oluşabilecek tüm hata ve bunların doğrudan ya da dolaylı sonuçlarından kendisinin sorumlu olduğunu kabul etmiş sayılır.</p>
                        <p class="text">3.11. <?php echo BRAND; ?>, sitenin içeriğini dilediği zaman değiştirme, kullanıcılara sağlanan herhangi bir hizmeti değiştirme ya da sona erdirme hakkını saklı tutar.</p>
                        <p class="text">3.12. <?php echo BRAND; ?>, üyelik sözleşmesinin koşullarını hiçbir şekil ve surette ön ihbara ve/veya ihtara gerek kalmaksızın her zaman değiştirebilir, güncelleyebilir veya iptal edebilir. Değiştirilen, güncellenen ya da yürürlükten kaldırılan her hüküm , yayın tarihinde tüm üyeler bakımından hüküm ifade edecektir.</p>
                        <p class="text">3.13. Taraflar, <?php echo BRAND; ?>'e ait tüm bilgisayar kayıtlarının tek ve gerçek münhasır delil olarak, HMK madde 193’e uygun şekilde esas alınacağını ve söz konusu kayıtların bir delil sözleşmesi teşkil ettiği hususunu kabul ve beyan eder.</p>
                        <p class="text">3.14. Üye ticari elektronik ileti tercihlerini“Hesabım” bölümündeki “Üyelik Bilgisi Güncelleme” kısmından yönetebileceğini bildiğini kabul eder.</p>
                        <p class="text">3.15. <?php echo BRAND; ?>'in Platform’da yer alan herhangi bir ürün veya hizmetin satıcısı konumunda olmaması durumunda <?php echo BRAND; ?> 6563 sayılı Elektronik Ticaretin Düzenlenmesi Hakkında Kanun uyarınca yalnızca "aracı hizmet sağlayıcı" ve 5651 sayılı İnternet Ortamında Yapılan Yayınların Düzenlenmesi ve Bu Yayınlar Yoluyla İşlenen Suçlarla Mücadele Edilmesi Hakkında Kanun uyarınca "yer sağlayıcı" konumundadır. <?php echo BRAND; ?>, Platform’da yer alan ve kendisi tarafından yayınlanmamış hiçbir görsel, yazılı veya sair içeriğin gerçekliğinden, güvenilirliğinden, doğruluğundan ya da hukuka uygunluğundan sorumlu değildir ve söz konusu içeriklerin doğruluğunu kontrol etme gibi bir yükümlülüğü bulunmamaktadır. Üye işbu durumu bildiği kabul ve beyan eder.</p>
                        <p class="text">3.16. <?php echo BRAND; ?>, Fraud şüphesi oluşturan bir siparişi Üye’ye önceden haber vermeksizin iptal etme hakkına sahip olup işbu iptal nedeniyle Üye’nin <?php echo BRAND; ?>'den herhangi bir talepte bulunma hakkı bulunmamaktadır.</p>
                        <p class="text">3.17. <?php echo BRAND; ?>, Üyeler’in verilerini 6698 sayılı Kişisel Verilerin Korunması Kanunu ile uyumlu olarak işlemekte ve korumaktadır. Üye kişisel verilerinin işlenmesi ve korunmasına ilişkin detaylı bilgiye https://www.hepsiburada.com/kisisel-verilerin-korunmasi adresinden ulaşabilir.</p>
                        
                        <p class="title-sub">4. Sözleşmenin Feshi</p>
                        <p class="text">İşbu sözleşme üyenin üyeliğini iptal etmesi veya <?php echo BRAND; ?> tarafından üyeliğinin iptal edilmesine kadar yürürlükte kalacaktır. Taraflardan her biri Üyelik Sözleşmesi'ni tek taraflı olarak ve tazminat ödemeksizin her zaman feshedebilir.<?php echo BRAND; ?> üyenin üyelik sözleşmesinin herhangi bir hükmünü ihlal etmesi durumunda üyenin üyeliğini iptal ederek sözleşmeyi tek taraflı olarak feshedebilecektir.</p>
                        
                        <p class="title-sub">5. İhtilaflerin Halli</p>
                        <p class="text">İşbu sözleşmeye ilişkin ihtilaflerde İstanbul Mahkemeleri ve İcra Daireleri yetkilidir.</p>

                        <p class="title-sub">6. Yürürlük</p>
                        <p class="text">Üyenin, üyelik kaydı yapması üyenin üyelik sözleşmesinde yer alan tüm maddeleri okuduğu ve üyelik sözleşmesinde yer alan maddeleri kabul ettiği anlamına gelir. İşbu Sözleşme üyenin üye olması anında akdedilmiş ve karşılıklı olarak yürürlülüğe girmiştir.</p>




                        <h2 class="title">Kullanım Şartları</h2>
