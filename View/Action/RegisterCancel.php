...
<head>
    <title>Üyelik İptal | <?php echo BRAND; ?></title>
    ...
    <main>
        <section class="action-section">
            <div class="action-container">
                <?php if (!empty($web_data['register_cancel_message'])) : ?>
                    <div class="verify-link-row">
                        <span class="verify-link-text"><?php echo $web_data['register_cancel_message']; ?></span>
