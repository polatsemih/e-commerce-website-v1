...
<head>
    ...
    <meta charset="UTF-8" />
    <title>İki Aşamalı Doğrulama | ' . BRAND . '</title>
    <style>
        * {
            margin: 0px;
            padding: 0px;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p class="text-1">' . BRAND . ' İki Aşamalı Doğrulama</p>
        </div>
        <main class="main">
            ...
            <p class="text-2">Giriş yapmak için üstteki kodu girin</p>
            <p class="text-3">Doğrulama kodunun kullanım süresi ' . EXPIRY_TWO_FA_TOKEN_MINUTE . ' dakikadır</p>
        </main>
        <footer class="footer">
            <p class="footer-text">Bu işlemi siz gerçekleştirmediyseniz, hemen ' . BRAND . ' hesabınızın şifresini değiştirin</p>
