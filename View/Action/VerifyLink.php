...
<head>
    <title><?php echo !empty($web_data['verify_link_title']) ? $web_data['verify_link_title'] . ' | ' : ''; ?><?php echo BRAND; ?></title>
    ...
    <main>
        <section class="action-section">
            <div class="action-container">
                <?php if (!empty($web_data['verify_link_msg'])) : ?>
                    <div class="verify-link-row">
                        <span class="verify-link-text"><?php echo $web_data['verify_link_msg']; ?></span>
                        <a href="<?php echo URL; ?>" class="verify-link-btn"><?php echo BRAND; ?> Ana Sayfaya Dön</a>
                    </div>
                <?php endif; ?>
            </div>
        </section>
