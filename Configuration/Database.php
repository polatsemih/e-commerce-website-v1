...
define('TABLE_COOKIE_AUTHENTICATION_CROSS_SITE', 'cookie_authentication_cross_site_axc61mkoi0');
...
define('TABLE_CONTACT', 'log_contact_uay1nvfwkj');
...
define('TABLE_ORDER_INITIALIZE_INFORMATIONS', 'order_initialize_informations_zlfy3ko914');
define('TABLE_ORDER_INSTALLMENT', 'order_installment_mko827dyvs');
define('TABLE_ORDER_INSTALLMENT_PRICES', 'order_installment_prices_al2u17f6sa');
define('TABLE_ORDER_MD_STATUS', 'order_md_status_lop0m62h54');
define('TABLE_ORDER_STATUS_ERROR', 'order_status_error_xmz91y6bgv');
define('TABLE_ORDER_PAYMENT_ITEM_TRANSACTION', 'order_payment_item_transaction_la92n6vh21');
define('TABLE_ORDER_PAYMENT', 'order_payment_xhs61ju8a7');
define('TABLE_ORDER_STATUS', 'order_status_7y61bh2uds');
define('TABLE_ORDER_VERIFY', 'order_verify_klaiqu2631');
